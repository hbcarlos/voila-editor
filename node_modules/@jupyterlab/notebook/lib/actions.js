...
(function (NotebookActions) {
    ...
    function trust(notebook, translator) {
        ...
        const trustMessage = (React.createElement("p", null,
            ...
            React.createElement("br", null),
            trans.__('For more information, see the <a href="https://jupyter-notebook.readthedocs.io/en/stable/security.html">%1</a>', trans.__('Jupyter security documentation'))));
        if (trusted) {
            return showDialog({
