...
export class MemoryUsage extends VDomRenderer {
    ...
    render() {
        ...
        if (!this.model.usageWarning) {
            return (React.createElement(TextItem, { title: this._trans.__('Current mem usage'), source: text }));
        }
        else {
            return (React.createElement(TextItem, { title: this._trans.__('Current mem usage'), source: text, className: nbresuse }));
        }
    }
}
/**
