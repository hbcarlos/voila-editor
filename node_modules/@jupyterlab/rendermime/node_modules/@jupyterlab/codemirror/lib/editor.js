...
export class CodeMirrorEditor {
    ...
    constructor(options) {
        ...
        const editor = (this._editor = Private.createEditor(shadowRoot, fullConfig));
    ...
    setOption(option, value) {
        ...
        if (this._config[option] !== value) {
            ...
            Private.setOption(this.editor, this.host.shadowRoot, option, value, this._config);
        }
    }
    /**
...
(function (Private) {
     ...
     */
    async function setTheme(editor, shadowRoot, theme) {
        let stylesheet;
        if (theme === 'jupyter') {
            ...
            const filename = theme === 'solarized light' || theme === 'solarized dark'
                ? 'solarized'
                : theme;
            const module = await import(`!!to-string-loader!css-loader!codemirror/theme/${filename}.css`);
            stylesheet = module.default;
        }
        const themeStyleEl = shadowRoot.getElementById(CODEMIRROR_THEME_STYLE_ID);
     ...
     * Set a config option for the editor.
     */
    function setOption(editor, shadowRoot, option, value, config) {
